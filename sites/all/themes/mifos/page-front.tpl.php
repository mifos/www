...
<body class="<?php print $body_classes; ?>">
      ...
      <div id="content"><div id="content-inner">
        ...
        <div id="featured-news-wrapper">
          <div id="featured-news">
            <div id="featured-news-inner">
              <h2>Community Spotlight</h2>
              <?php
                $block = module_invoke('views', 'block', 'view', 'feeds-block_2');
                print $block['content'];
              ?>
            </div> <!-- featured-news-inner -->
          </div> <!-- featured-news -->
  ...
  <script type="text/javascript" src="http://twitter.com/statuses/user_timeline/mifos.json?callback=twitterCallback2&amp;count=3"></script>
