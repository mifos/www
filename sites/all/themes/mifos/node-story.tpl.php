...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"><div class="node-inner">
  ...
  <div class="content">
    <div class="floated-img bordered-img">
      <a href="<?php echo base_path() . $node->field_news_image[0]['filepath'] ?>" class="imagecache-imagelink">
        <?php print theme('imagecache', 'news-image', $node->field_news_image[0]['filepath']); ?>
      </a>
    </div>
