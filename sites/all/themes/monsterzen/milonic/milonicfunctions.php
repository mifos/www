...
function BuildTopNavRow($row,$sSelected)
{
	...
	if (strcasecmp($row['link_title'],"blog")!=0) 
	{
		// override to not allow links on top nav.
		$sLinkPath = "javascript:void(0);";
	}
	
	$s .= "<div id='topnavlink_" . $row['mlid'] . "' onMouseOut=\"popdown(); return false;\" ";
