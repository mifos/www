...
mytrace("page-blog.tpl.php: version 1.00");

mytrace("base_path = [$base_path], directory = [$directory]");

$my_current_section = GetCurrentSection();
mytrace("my_current_section=$my_current_section");


//dvm(GetCurrentPageName());
...
mytrace("top level menu count = $nTopLevelMenuCount");
?>
...
<?php if (IsFireFox()) {?>
<link type="text/css" rel="stylesheet" media="all" href="<?php echo $base_path, $directory; ?>/date.css? <?php echo GenerateQSAppend(); ?>" />
<link type="text/css" rel="stylesheet" media="all" href="<?php echo $base_path, $directory; ?>/calendar.css? <?php echo GenerateQSAppend(); ?>" />
<?php } // if (IsFireFox()) ?>
...
<body onload="MM_preloadImages('<?php echo $base_path, $directory; ?>/myimages/common/logo_over.gif','<?php echo $base_path, $directory; ?>/myimages/common/contact_over.gif','<?php echo $base_path, $directory; ?>/myimages/common/logosmall_over.gif','<?php echo $base_path, $directory; ?>/myimages/common/donate_over.gif','<?php echo $base_path, $directory; ?>/myimages/common/facebook_over.gif','<?php echo $base_path, $directory; ?>/myimages/common/twitter_over.gif','<?php echo $base_path, $directory; ?>/myimages/common/flickr_over.gif','<?php echo $base_path, $directory; ?>/myimages/common/youtube_over.gif','<?php echo $base_path, $directory; ?>/myimages/common/sharewhitebg_over.gif','<?php echo $base_path, $directory; ?>/myimages/common/search_over.gif','<?php echo $base_path, $directory; ?>/myimages/common/grameenlogo_over.gif')">
<script language="JavaScript" type="text/JavaScript">
<!--
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  ...
  <tr height="98%">
    <td align="left" valign="top"><div id="page">
        ...
        <div id="maincontent" class="blogbg">
          <table width="900" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="653" rowspan="2" align="left" valign="top"><div class="intblogcontent"> <?php print $messages; ?>
              ...
              <td width="242" rowspan="2" align="left" valign="top" class="greenvertical"><!-- BEGIN RIGHTNAV MENU -->
                <img src="<?php echo $base_path, $directory; ?>/myimages/blog/blog_rightnav_leading.gif" />
                <!--<div class="rightnavgap"></div>-->
                <div class="rightnavcontentleadinggap"></div>
                <!-- END RIGHTNAV MENU -->
                <!-- Begin social icons -->
                <div class="intpageblogsociallinks">
                  <table width="201" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="87" align="left" valign="top"><a target="_blank" href="http://www.addthis.com/bookmark.php?v=250&amp;username=mifos" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('shareit','','<?php echo $base_path, $directory; ?>/myimages/common/sharewhitebg_over.gif',1); return addthis_open(this, '', '[URL]', '[TITLE]')"><img src="<?php echo $base_path, $directory; ?>/myimages/common/sharewhitebg.gif" alt="share it" name="shareit" width="74" height="25" border="0" id="shareit" class="sharethisicon"/></a></td>
                      <script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#username=mifos"></script>
                    </tr>
                  </table>
                </div>
                <!-- end social icons -->
                <div class="rightcolintcontent"> <?php print $right; ?> </div>
                <div class="rightcolintcontent"></div></td>
            </tr>
            <tr>
              <td align="left" valign="top"><img src="<?php echo $base_path, $directory; ?>/myimages/blog/blogbackground.gif" width="5" height="100"/></td>
            </tr>
            <tr>
              <td align="left" valign="top">&nbsp;</td>
              <td align="left" valign="top">&nbsp;</td>
              <td align="left" valign="top"><div class="intpageblogsociallinks">&nbsp;</div></td>
            </tr>
          </table>
        </div>
              ...
              <tr>
                <td width="900" align="left" valign="top" class="bottomcenter"><div id="dottedline_900"></div>
                  <div id="bottomnavlinks" align="left">
                    <table width="900" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" valign="middle" nowrap="nowrap" class="infolink"><a href="mailto:<?php print EMAIL_LINK;?>"><strong><?php print EMAIL_LINK;?></strong></a>&nbsp;&nbsp;&nbsp;<?php if ($secondary_links) print theme('links', $secondary_links); ?></td>
                      </tr>
                    </table>
                  </div>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="middle" class="menubarsborder"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td width="5%" align="left" valign="middle" nowrap="nowrap" class="supplemental_links"><a href="http://www.mifos.com" target="_blank"><strong>Mifos</strong></a></td>
                              <td width="2%" align="center" valign="middle" nowrap="nowrap" class="supplemental_links_separator">|</td>
                              ...
                              <td width="35%" align="left" valign="middle" nowrap="nowrap" class="supplemental_links"><a href="http://www.bankerswithoutborders.com" target="_blank"><strong>Bankers Without Borders</strong></a> </td>
                            </tr>
                            <tr>
