...
mytrace("page.tpl.php: version 1.10");
/* 
	1.01 7-8-10 mfindlay; removed facts.htm
*/
    ...
    <td align="left" valign="top"><div id="page">
        ...
        <div id="maincontent">
          <table width="900" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="653" rowspan="2" align="left" valign="top"><div class="intbodycontent">
                  <!-- mfindlay 7/1/10 -->
                  <?php if (strlen($my_current_section)>0) {?>
                  <img src="<?php echo $base_path, $directory; ?>/myimages/headers/<?php print GetIntPageHeaderImg($my_current_section); ?>" width="653" height="200" border="0" usemap="#Map" />
                  <?php } // if (strlen($my_current_section)>0)?>
                </div>
                <div class="intbreadcrumb"><?php print $breadcrumb; print $title;?></div>
                <?php print $messages; ?>
              ...
              <td width="242" rowspan="2" align="left" valign="top" class="greenvertical"><!-- BEGIN RIGHTNAV MENU -->
                ...
                <!-- END RIGHTNAV MENU -->
                <!-- Begin social icons -->
                <div class="rightcolintsocialcontent">
                ...
                <!--<div class="rightcolintcontent">
                  <?php require_once ($directory . "/include/facts.htm"); ?>
                </div>--></td>
            </tr>
            <tr>
              <td align="left" valign="top"><img src="<?php echo $base_path, $directory; ?>/myimages/common/whitespacer.gif" width="5" height="209"/></td>
            </tr>
            <tr>
              <td align="left" valign="top">&nbsp;</td>
              <td align="left" valign="top">&nbsp;</td>
              <td align="left" valign="top"><!--<div class="intpagesociallinks"></div>-->
                &nbsp;</td>
            </tr>
          </table>
        </div>
...
<!-- mfindlay 7/1/10 map header image to contact us -->
<map name="Map" id="Map">
  <area shape="rect" coords="8,129,647,193" href="/?q=about/contact-us" />
</map>
<script type="text/javascript">
