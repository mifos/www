$Id: README.txt,v 1.1.4.1.2.1.2.6 2010/02/10 19:47:19 yhahn Exp $
...
A snippet from `spaces_blog.info`, an example spaces-enabled feature included
with Spaces:
...
implementing a `system_settings_form()` at `features/[my-feature]/settings`. If
spaces finds such a page defined by your feature, it will expose it as a link in
